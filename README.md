...
`cd models/research python3 setup.py build && python3 setup.py install` 
...
Extract the pretrained TensorFlow model files. 
...
`python3 object_detection/export_tflite_ssd_graph.py \ 
  ...
  --trained_checkpoint_prefix PATH_TO_CHECKPOINT_FILE \ 
...
`tflite_convert \ 
  ...
  --output_file=PATH_TO_TFLITE_DIRECTORY` 
